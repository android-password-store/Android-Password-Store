...
object Dependencies {
    ...
    object AndroidX {
        ...
        const val lifecycle_common = "androidx.lifecycle:lifecycle-common-java8:2.3.0-alpha05"
        const val lifecycle_livedata_ktx = "androidx.lifecycle:lifecycle-livedata-ktx:2.3.0-alpha05"
        const val lifecycle_viewmodel_ktx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.3.0-alpha05"
        const val material = "com.google.android.material:material:1.3.0-alpha01"
        const val preference = "androidx.preference:preference:1.1.1"
        const val recycler_view = "androidx.recyclerview:recyclerview:1.2.0-alpha04"
    ...
    object FirstParty {
        ...
        const val zxing_android_embedded = "com.github.android-password-store:zxing-android-embedded:v4.1.0-aps"
    }

    object ThirdParty {

        const val bouncycastle = "org.bouncycastle:bcprov-jdk15on:1.65.01"
        const val commons_codec = "commons-codec:commons-codec:1.13"
        ...
        const val whatthestack = "com.github.haroldadmin:WhatTheStack:0.0.3"
    }
